...
import { DiscourseService, CryptoService, NEARService, NonceManager, LinkageStore } from "./service";
/**
 * Discourse Plugin
 *
...
declare const _default: import("every-plugin").LoadedPluginWithBinding<{
    getUserApiAuthUrl: import("@orpc/contract").ContractProcedure<z.ZodObject<{
    ...
    completeLink: import("@orpc/contract").ContractProcedure<z.ZodObject<{
        payload: z.ZodString;
        nonce: z.ZodString;
    ...
    createPost: import("@orpc/contract").ContractProcedure<z.ZodObject<{
        authToken: z.ZodString;
        title: z.ZodString;
        raw: z.ZodString;
    ...
    getLinkage: import("@orpc/contract").ContractProcedure<z.ZodObject<{
        nearAccount: z.ZodString;
